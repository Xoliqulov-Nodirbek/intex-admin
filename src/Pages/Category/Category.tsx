  ...
  return (
    <>
      <div className="bg-white flex items-center w-full pt-1.5 pb-1.5 px-8">
        ...
        <Link to="/category">
          <h2 className='font-normal text-navSubColor text-xs ml-2.5'>Категории</h2>
        </Link>
      </div>
      <div className='pt-6 pb-8 px-homeContentPadding '>
        <div>
          <h2 className='text-navBarColor font-bold leading-8 text-2xl mb-4'>Категории</h2>
          <div className='bg-white py-3 px-4 rounded-xl flex items-center justify-between'>
            ...
            <div className='flex items-center'>
              ...
              <Link to={"/addCategory"} className='add bg-filterBg'>Добавить</Link>
            </div>
          </div>
        </div>
      </div>
